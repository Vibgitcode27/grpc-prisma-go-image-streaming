...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=process_manager.Storage_Driver" json:"driver,omitempty"`
...
var file_proto_storage_message_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x70,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x70, 0x72, 0x6f, 0x63, 0x65, 0x73, 0x73,
	0x5f, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x72, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65,
	...
	0x12, 0x07, 0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x06, 0x5a, 0x04, 0x2f, 0x70, 0x73,
...
var file_proto_storage_message_proto_goTypes = []any{
	(Storage_Driver)(0), // 0: process_manager.Storage.Driver
	(*Storage)(nil),     // 1: process_manager.Storage
	(*Memory)(nil),      // 2: process_manager.Memory
}
var file_proto_storage_message_proto_depIdxs = []int32{
	0, // 0: process_manager.Storage.driver:type_name -> process_manager.Storage.Driver
	2, // 1: process_manager.Storage.memory:type_name -> process_manager.Memory
